...
const SimpleShareButtons = () => {
  ...
  return (
    <div className="fixed top-4 left-1/2 transform -translate-x-1/2 border border-black bg-white rounded-xl shadow-md py-4 sm:py-8 px-6 sm:px-12 flex flex-row items-center justify-center sm:justify-start gap-14 sm:gap-12 lg:gap-40 mt-[5%] sm:mt-[10%] w-[90%] sm:w-auto">
  <button
