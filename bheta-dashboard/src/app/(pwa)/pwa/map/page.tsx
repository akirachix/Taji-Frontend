...
const PharmacyFinderComponent: React.FC = () => {
  ...
  const revokedPharmacies = [
    "The Chemist",
    "Rhino ( K) Ltd",
    "AGA KHAN HOSPITAL-VALLEY ARCADE CLINIC",
    "BLISS GVS HEALTHCARE LIMITED MURANG'A",
    "BLISS GVS HEALTHCARE LIMITED -THIKA",
    "BLISS GVS HEALTHCARE LIMITED -BURUBURU",
    "CLEARVIEW SPECIALIST MEDICARE"
  ];
...
export default PharmacyFinderComponent;