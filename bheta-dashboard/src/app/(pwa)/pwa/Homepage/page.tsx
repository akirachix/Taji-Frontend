...
const CheckDrugStatus = () => {
  ...
  <h2 className="text-[26px] sm:text-[28px] md:text-[35px] lg:text-[48px] font-semibold mb-4 text-center lg:text-left mt-[1%] lg:mt-[5%] darker grotesque">
    Stay Safe With Every Dose!
  </h2>
  <p className="text-black mb-6 text-[20px] sm:text-[18px] md:text-[20px] lg:text-[32px] text-center lg:text-left leading-relaxed lg:mt-[2%] darker grotesque ">
  ...
  <Link href="/pwa/landing">
    <button className="text-white px-8 sm:px-12 py-4 sm:py-5 rounded-[8px] sm:rounded-[12px] focus:outline-none focus:ring-2 focus:ring-offset-2 darker grotesque " style={{ backgroundColor: '#1B264F' }}>
      Check drug
    </button>
  </Link>
</div>
