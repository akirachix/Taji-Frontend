...
const CameraPermission = () => {
  ...
  if (!isVisible) {
    return (
      <div className="flex-col flex items-center justify-center gap-4 lg:mt-[10%]  mt-[10%]">
        <p className="text-black">Permission request canceled.</p>
        
        <Link href="/pwa/takepicture">
          <button className="mt-4 px-4 py-2 text-white rounded-md" style={{ backgroundColor: '#1B264F' }}>
            Go Back Home
          </button>
        </Link>
      </div>
