...
//         setResponseMessage(typeof responseValue === 'string' ? responseValue : JSON.stringify(responseValue));
//       } else {
//         // Check if the error is specifically about no batch number found
//         if (data.error && data.error.includes('batch')) {
//           setResponseMessage('Batch number not valid');
//         } else {
...
//           <X className="w-6 h-6 text-gray-500" />
//         </button>
//         <h2 className="text-2xl font-bold text-center">Response</h2>
//         <p className="text-center">{responseMessage}</p>
//         <div className="flex justify-around mt-6">
//         <Link href="/pwa/share">
//           <button
