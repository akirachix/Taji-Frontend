...
//   const [imageFile, setImageFile] = useState<File | null>(null);
//   const [isLoading, setIsLoading] = useState<boolean>(false);
//   const [responseData, setResponseData] = useState<DrugResponse | null>(null);
//   const [showResponsePage, setShowResponsePage] = useState<boolean>(false);
//   const fileInputRef = useRef<HTMLInputElement>(null);
//   const router = useRouter();
...
//         <h2 className="text-2xl font-bold text-center mb-6">Drug Status</h2>
        
//         {responseData?.details && (
//           <div className="space-y-4">
//             <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
//               <h3 className="font-bold text-red-700 mb-2">
//                 Status: {responseData.details.status?.toUpperCase() || 'N/A'}
//               </h3>
//               <p className="text-gray-800 font-medium">
//                 Drug Name: {responseData.details.drug_name || 'N/A'}
//               </p>
//               <p className="text-gray-800">
//                 Batch Number: {responseData.details.batch_number || 'N/A'}
//               </p>
//               <p className="text-gray-800">
//                 Recall Date: {responseData.details.recall_date || 'N/A'}
//               </p>
//               <p className="text-gray-800">
//                 Reason: {responseData.details.reason_for_recall || 'N/A'}
//               </p>
//             </div>
